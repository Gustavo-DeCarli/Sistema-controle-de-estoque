        ...
        <div class='edit'>
            <form class='editaform p-3' action='lib/editarp.php' method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name='cod' id="cod" placeholder="Código do Produto" value=''>
                </div>
                <div class="mb-3">
                    <label for="nomeprod" class="form-label">Nome do Produto</label>
                    <input type="text" class="form-control" name='nomeprod' id="nomeprod" placeholder="Nome do Produto" value=''>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name='estoque' id="estoque" placeholder="Quantidade em Estoque" value=''>
                </div>
                <div class="mb-3">
                    <label for="valorprod" class="form-label">Preço de Custo</label>
                    <input type="number" step=0.01 class="form-control" name='valorprod' id="valorprod" placeholder="Valor do Produto" value=''>
                </div>
                <div class="mb-3">
                    <label for="valorv" class="form-label">Preço de Venda</label>
                    <input type="number" step=0.01 class="form-control" name='valorv' id="valorv" placeholder="Valor do Produto" value=''>
                </div>
                <div class="mb-3">
